...
<template>
  <div class="navbar bg-primary/10">
    <div class="navbar-start">
      <div class="dropdown">
        ...
        >
          ...
          <li><RouterLink :to="{ name: 'AdminModels' }">Modelos</RouterLink></li>
          <li><RouterLink :to="{ name: 'AdminUsers' }">Usuarios</RouterLink></li>
          <li><RouterLink :to="{ name: 'AdminFaculties' }">Facultades</RouterLink></li>
        </ul>
      </div>
